...
class Kaynaklar {
  ...
  Kaynaklar({this.id, this.kaynakAdi, this.kayitSayisi});

  Kaynaklar.fromJson(Map<String, dynamic> json) {
    id = json['id'];
  ...
  Map<String, dynamic> toJson() {
    ...
    return data;
      ...
      Kaynaklar getObj(json) => Kaynaklar.fromJson(json);
  static Future<List> fromAPI(String token,String data) async {
    final Response response =
        await post(Uri.parse(API_URL + "api/lst/alanlarlst"),
    ...
    if (response.statusCode == 200) {
      return response.body.toList(new Kaynaklar());
   ...
   static Future<List> fromLocal() async {
    return await (new KaynaklarDb().getAll());
  }
}
